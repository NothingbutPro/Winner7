...
class WinnerHistoryActivity : AppCompatActivity() {
...
//    }
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.winnerhistoryactivity)
        setSupportActionBar(toolbar)
    ButterKnife.bind(this@WinnerHistoryActivity);
    val context = this@WinnerHistoryActivity
...
val context = this@GetAllWinners.s
         ...
         override fun doInBackground(vararg params: Void?): String {
             ...
             try {
                 ...
                 val url = URL("https://winner7quiz.com/api/getuserwinnerlist")
